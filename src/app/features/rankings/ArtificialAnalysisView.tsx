...
import { TabButton } from "../../components/composite/TabButton";
...
import { RANKING_BENCHMARK_KEYS, BENCHMARK_LABELS } from "../../../shared/config/benchmarks";
import { buildBenchmarkColumns } from "./benchmarkColumns";

function getRowId(model: ArtificialAnalysisModel) {
      ...
      {viewMode !== "benchmarks" && (
        <>
          ...
          <DataTable
            ...
            getRowId={modelId as (m: ArtificialAnalysisModel) => string}
