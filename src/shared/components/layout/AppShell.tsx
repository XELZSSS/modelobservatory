...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="h-screen flex flex-col bg-bg-primary overflow-x-hidden">
      ...
      <main id="main-content" tabIndex={-1} className="flex-1 min-h-0 overflow-y-auto [scrollbar-gutter:stable] px-2 md:px-6 pt-2 md:pt-3 pb-[calc(72px+env(safe-area-inset-bottom,0px))] sm:pb-[calc(80px+env(safe-area-inset-bottom,0px))] md:pb-[80px]">
        {children}
      </main>
